...
const translations = {
  es: {
    ...
    'register.document': 'Número de documento',
    ...
    'register.success': 'Registro exitoso. Ahora inicia sesión.',
    ...
    'register.successMessage': 'Registro exitoso. Ahora inicia sesión.',
    
    // Dashboard
    'dashboard.title': 'Panel de Inicio',
    'dashboard.subtitle': 'Resumen rápido y accesos directos — colores suaves para una lectura cómoda.',
    ...
    'dashboard.vehiclesDesc': 'Gestión de automóviles',
    ...
    'dashboard.quickSummary': 'Resumen rápido y accesos directos — colores suaves para una lectura cómoda.',
    ...
    'dashboard.quickAccessTitle': 'Accesos Rápidos',
    'dashboard.profileTitle': 'Perfil',
    'dashboard.profileDescription': 'Ver datos personales',
    'dashboard.configurationTitle': 'Configuración',
    'dashboard.configurationDescription': 'Opciones del sistema',
    'dashboard.vehiclesTitle': 'Vehículos',
    'dashboard.vehiclesDescription': 'Gestión de automóviles',
    ...
    'movements.registerNew': '🚗 Registrar nuevo movimiento',
    'movements.platePlaceholder': 'Placa del vehículo',
    'movements.entry': 'Entrada',
    'movements.exit': 'Salida',
    'movements.history': '🧾 Historial de Movimientos',
    'movements.plate': 'Placa',
    'movements.type': 'Tipo',
    'movements.time': 'Hora',
    'movements.date': 'Fecha',
    'movements.noMovements': 'No hay movimientos registrados aún.',
    'movements.invalidPlate': 'Ingresa una placa válida',
    'movements.entrance': 'Entrada',
    'movements.exitType': 'Salida',
    
    // Vehicles
    'vehicles.title': 'Registrar Vehículo',
    'vehicles.pageTitle': 'Registrar Vehículo',
    'vehicles.editTitle': '✏️ Editar Vehículo',
    ...
    'vehicles.registerAuto': 'Registrar (Automático)',
    'vehicles.changeToManual': 'Cambiar a Manual',
    'vehicles.saveChanges': 'Guardar cambios',
    'vehicles.cancel': 'Cancelar',
    'vehicles.registered': 'Vehículos Registrados',
    'vehicles.registeredList': 'Vehículos Registrados',
    'vehicles.noVehicles': 'No hay vehículos aún.',
    'vehicles.noMatches': 'No hay vehículos que coincidan.',
    'vehicles.edit': 'Editar',
    'vehicles.delete': 'Eliminar',
    'vehicles.deleteConfirm': '¿Eliminar vehículo? Esta acción no se puede deshacer.',
    'vehicles.total': 'total',
    'vehicles.clearList': 'Vaciar lista',
    'vehicles.listCleared': 'Lista vaciada',
    'vehicles.cameraStarted': 'Cámara iniciada (modo automático)',
    'vehicles.cameraError': 'No se pudo acceder a la cámara (revisa permisos)',
    'vehicles.browserNotSupported': 'Tu navegador no soporta getUserMedia',
    'vehicles.nameRequired': 'El nombre es obligatorio',
    'vehicles.invalidPlate': 'Placa inválida (solo letras, números y guiones, 3-8 caracteres)',
    'vehicles.duplicatePlate': 'Ya existe un vehículo con esa placa',
    'vehicles.vehicleUpdated': 'Vehículo actualizado',
    'vehicles.vehicleRegistered': 'Vehículo registrado',
    'vehicles.vehicleDeleted': 'Vehículo eliminado',
    'vehicles.vehicleRegisteredAuto': 'Vehículo registrado (modo automático)',
    'vehicles.cameraNotStarted': 'Cámara no iniciada',
    ...
    'vehicles.noPlateDetected': 'No se detectó placa en la imagen',
    ...
    'vehicles.stopCamera': 'Detener cámara',
    'vehicles.confidence': 'Confianza',
    'vehicles.noVehiclesToExport': 'No hay vehículos para exportar',
    'vehicles.captureError': 'Error al capturar imagen',
    
    // Users Page
    'users.title': 'Administración de Usuarios',
    'users.subtitle': 'Lista de usuarios registrados — ver, editar o eliminar.',
    ...
    'users.deleteConfirm': '¿Eliminar este usuario? Esta acción no se puede deshacer.',
    ...
    // Summary Page
    'summary.welcomeUser': '¡Bienvenido, Nicolás!',
    ...
    'summary.lastMovementsTitle': 'Últimos movimientos',
    'summary.noMovementsMessage': 'No hay movimientos aún.',
    ...
    'config.language': 'Configuración de Idioma',
    'config.name': 'Nombre',
    ...
    'config.success': 'Configuración guardada exitosamente',
    'config.error': 'Error al guardar la configuración',
    'config.theme': 'Tema',
    'config.darkMode': 'Modo Oscuro',
    'config.lightMode': 'Modo Claro',
    'config.auto': 'Automático',
    'config.systemInfo': 'Información del Sistema',
    'config.version': 'Versión',
    'config.framework': 'Framework',
    'config.status': 'Estado',
    'config.active': 'Activo',
    'config.autoSave': 'El idioma se cambia automáticamente y se guarda para futuras sesiones.',
    'config.saving': 'Guardando...',
    'config.namePlaceholder': 'Ingresa tu nombre completo',
    'config.emailPlaceholder': 'correo@ejemplo.com',
    'config.documentPlaceholder': 'Número de documento',
    
    // VehicleModal
    'vehicleModal.title': 'Registrar Vehículo',
    'vehicleModal.ownerName': 'Nombre del dueño',
    'vehicleModal.plate': 'Placa',
    'vehicleModal.vehicleType': 'Tipo de vehículo',
  ...
  en: {
    ...
    'dashboard.subtitle': 'Quick overview and shortcuts — soft colors for comfortable reading.',
    ...
    'dashboard.quickSummary': 'Quick overview and shortcuts — soft colors for comfortable reading.',
    ...
    'movements.registerNew': '🚗 Register new movement',
    ...
    'vehicles.editTitle': '✏️ Edit Vehicle',
    ...
    'users.subtitle': 'List of registered users — view, edit or delete.',
    ...
    // Summary Page
    'summary.welcomeUser': 'Welcome, Nicolás!',
